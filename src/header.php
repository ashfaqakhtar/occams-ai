...
<body class="overflow-x-hidden">
    <header class="fixed top-0 left-0 right-0 z-40 w-full py-9.75 px-4">
        <div class='container mx-auto flex justify-between items-center px-4'>
            <div class='flex justify-between w-full'>
                <div class="inline-block my-auto">
                    <img src='./assets/images/occams-ai.svg' alt='Occams Ai' class="lg:h-12 h-10 max-w-max" />
                </div>
            ...
            <button id="menu-toggle" class="md:hidden flex items-center justify-center cursor-pointer">
                ...
                <svg id="close-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    ...
                    class="absolute w-9.75 h-9.75 text-[#0C84BC] transition-all duration-300 ease-in-out opacity-0 rotate-90">
